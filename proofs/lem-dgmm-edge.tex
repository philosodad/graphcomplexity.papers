...
\end{lem}
\begin{IEEEproof}[Proof of Lemma~\ref{lem:dgmm-edge}]
  ...
  \begin{IEEEproof}[Proof of Proposition~\ref{prop:dgmm-edge-order}]
  ...
  \end{IEEEproof}
  \begin{IEEEproof}[Proof of Proposition~\ref{prop:dgmm-edge-match}]
...
At the beginning of every communication round, each node makes an equally weighted random decision to either issue an invitation or wait for invitations. We consider these options by cases.
  ...
  \end{IEEEproof}
  \begin{IEEEproof}[Proof of Proposition~\ref{prop:dgmm-edge-once}]
