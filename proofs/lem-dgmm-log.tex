...
\begin{IEEEproof}[Proof of Lemma~\ref{lem:dgmm-log}]
\begin{lprp}
...
\end{lprp}
\begin{IEEEproof}[Proof of Proposition~\ref{prop:dgmm-log-each}]
...
\end{IEEEproof}
\begin{IEEEproof}[Proof of Proposition~\ref{prop:dgmm-log-alpha}]
